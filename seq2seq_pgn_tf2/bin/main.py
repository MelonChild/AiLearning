...
def main():
    ...
    # 模型参数
    parser.add_argument("--max_enc_len", default=200, help="Encoder input max sequence length", type=int) #输入长度
    parser.add_argument("--max_dec_len", default=40, help="Decoder input max sequence length", type=int) #输出长度
    ...
    parser.add_argument("--beam_size", default=3,
                        ...
                        type=int)
    parser.add_argument("--vocab_size", default=30, help="Vocabulary size", type=int)
